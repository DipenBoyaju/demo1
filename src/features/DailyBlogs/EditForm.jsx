...
const EditForm = () => {
  ...
  const blogSchema = Yup.object({
    ...
    email: Yup.string().email('Invalid email address').matches(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|.(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/, 'custom message').required('Required'),
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-1 flex flex-col gap-3 space-y-2">
          ...
          <div >
            ...
            {errors.place && touched.place && <p className="text-red-500 text-sm">{errors.place}</p>}
          </div>
          ...
          <div className="w-96">
            <Textarea
              ...
              onChange={handleChange}
              label="Description" />
            {errors.detail && touched.detail && <p className="text-red-500 text-sm">{errors.detail}</p>}
          </div>
          ...
          <div>
            ...
            <Input
              ...
              type="file" />
            <div className="my-2">
              {values.image && touched.image && <img src={values.image} alt="" />}
